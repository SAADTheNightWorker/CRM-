...
const uploadFields = [
  { key: "previous_quote", title: "Previous Quote" },
  { key: "passing", title: "Passing" },
  { key: "transfer_owner_certificate", title: "Transfer Owner Certificate" },
  { key: "trade_license", title: "Trade License" },
  { key: "list_of_vehicles", title: "List Of Vehicles" },
  { key: "existing_quote", title: "Existing Quote" },
  { key: "other_doc", title: "Other Doc" },
];

const FleetManagementForm = ({ handleOpen, open, setOpen }) => {
  ...
  const [checker, setChecker] = React.useState({
    ...
    passing: false,
    transfer_owner_certificate: false,
    trade_license: false,
    list_of_vehicles: false,
  ...
  const {
    ...
    defaultValues: {
      ...
      previous_quote: null,
      passing: null,
      transfer_owner_certificate: null,
      trade_license: null,
      list_of_vehicles: null,
      existing_quote: null,
      other_doc: null,
    },
  });
  ...
  const handleSub = async (data) => {
    ...
    formData.append("previous_quote", data.previous_quote);
    formData.append("passing", data.passing);
    formData.append(
      "transfer_owner_certificate",
      data.transfer_owner_certificate
    );
    formData.append("trade_license", data.trade_license);
    formData.append("list_of_vehicles", data.list_of_vehicles);
    formData.append("existing_quote", data.existing_quote);
    formData.append("other_doc", data.other_doc);
    ...
    const response = await dispatch(createFleetManagement(formData));
