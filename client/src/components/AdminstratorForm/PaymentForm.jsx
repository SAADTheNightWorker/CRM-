...
const PaymentForm = ({ handleOpen, open, setOpen }) => {
  const {
    control,
    handleSubmit,
    reset,
  ...
  const onSubmit = async (data) => {
    ...
    const response = await dispatch(createPayment(newData));
  ...
  return (
    <div className="bg-white min-h-[25vh] border border-gray-300 shadow-lg p-4 rounded-lg">
      <div className="flex justify-between items-center mb-4">
        <div className="text-xl font-semibold text-gray-500">Add Payment</div>
